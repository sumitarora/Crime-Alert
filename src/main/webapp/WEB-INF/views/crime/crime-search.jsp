...
<div class="container">
	...
	<div class="text-center">
		...
		%>
			...
			<a class="btn btn-info btn-sm" href="${pageContext.request.contextPath}/search?criteria=<%= request.getParameter("criteria") %>&type=<%= request.getParameter("type") %>&useopendata=<%= request.getParameter("useopendata") %>&list=l&by=<%= request.getParameter("by") %>">
				<i class="fa fa-list"></i> View List
			</a>
		<%	    			
    		} else if(list != null && list.equals("hm")){
    	%>
			<a class="btn btn-success btn-sm" href="${pageContext.request.contextPath}/search?criteria=<%= request.getParameter("criteria") %>&type=<%= request.getParameter("type") %>&useopendata=<%= request.getParameter("useopendata") %>&list=hm&by=<%= request.getParameter("by") %>">
				<i class="fa fa-map-marker"></i> View Heat Map
			</a>
			<a class="btn btn-info btn-sm" href="${pageContext.request.contextPath}/search?criteria=<%= request.getParameter("criteria") %>&type=<%= request.getParameter("type") %>&useopendata=<%= request.getParameter("useopendata") %>&list=m&by=<%= request.getParameter("by") %>">
				<i class="fa fa-map-marker"></i> View Map
			</a>				
			<a class="btn btn-info btn-sm" href="${pageContext.request.contextPath}/search?criteria=<%= request.getParameter("criteria") %>&type=<%= request.getParameter("type") %>&useopendata=<%= request.getParameter("useopendata") %>&list=l&by=<%= request.getParameter("by") %>">
				<i class="fa fa-list"></i> View List
    	...
    	%>
			<a class="btn btn-info btn-sm" href="${pageContext.request.contextPath}/search?criteria=<%= request.getParameter("criteria") %>&type=<%= request.getParameter("type") %>&useopendata=<%= request.getParameter("useopendata") %>&list=hm&by=<%= request.getParameter("by") %>">
				<i class="fa fa-map-marker"></i> View Heat Map
			</a>    	
			<a class="btn btn-info btn-sm" href="${pageContext.request.contextPath}/search?criteria=<%= request.getParameter("criteria") %>&type=<%= request.getParameter("type") %>&useopendata=<%= request.getParameter("useopendata") %>&list=m&by=<%= request.getParameter("by") %>">
				<i class="fa fa-map-marker"></i> View Map
			</a>	
			<a class="btn btn-success btn-sm" href="${pageContext.request.contextPath}/search?criteria=<%= request.getParameter("criteria") %>&type=<%= request.getParameter("type") %>&useopendata=<%= request.getParameter("useopendata") %>&list=l&by=<%= request.getParameter("by") %>">
				<i class="fa fa-list"></i> View List
			</a>
		<%	    			
    		}	    	
