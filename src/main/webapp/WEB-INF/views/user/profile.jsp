...
<form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/profile/save" method="post">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
      <input type="text" class="form-control" id="title" placeholder="First Name" value="${user.firstName}" name="firstName" required="true">
    </div>
  </div>
  <div class="form-group">
    <label for="description" class="col-sm-2 control-label">Last Name</label>
    <div class="col-sm-4">
      <input type="text" class="form-control" id="description" placeholder="Last Name" value="${user.lastName}" name="lastName" required="true">
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
      <textarea class="form-control" id="address" placeholder="About" name="about">${user.about}</textarea>
    </div>
  </div>
  <div class="form-group">
